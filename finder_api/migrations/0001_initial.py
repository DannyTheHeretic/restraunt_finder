# Generated by Django 5.1.3 on 2024-12-22 07:11
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Name of the Restraunt')),
                ...
                ('catagory', models.ManyToManyField(to='finder_api.cuisine')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('favorites', models.ManyToManyField(related_name='Favorites', to='finder_api.restraunt')),
            ],
            options={
                'db_table': 'auth_user',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('restraunt', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='finder_api.restraunt')),
